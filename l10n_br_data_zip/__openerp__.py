...
{
    "name": "Brazilian Localization Data Extension for Base with brazilian zip codes",
    "description": "Brazilian Localization Data Extension for Base with brazilian zip codes",
    'license': 'AGPL-3',
