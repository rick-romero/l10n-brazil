...
FISCAL_POSITION_COLUMNS = {
    ...
    'fiscal_category_id': fields.many2one('l10n_br_account.fiscal.category', 'Categoria Fiscal'),
...
class account_fiscal_position_tax_template(orm.Model):
...
class account_fiscal_position_tax(orm.Model):
